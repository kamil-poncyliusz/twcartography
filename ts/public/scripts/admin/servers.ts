import { handleCreateServer } from "../../../routes/api/server-handlers.js";
...
//   const serverId = parseInt(button.dataset.serverId ?? "");
//   if (!isValidId(serverId)) throw new Error("Invalid server id");
//   const payload = { id: serverId };
//   const method = HttpMethod.DELETE;
//   const endpoint = `${serverEndpoint}/${serverId}`;
//   const isDeleted: Awaited<ReturnType<typeof handleDeleteServer>> = await httpRequest(endpoint, method, payload);
